...
class EvaluationScores(BaseModel):
    ...
    professional_structure_score: float = Field(ge=0.0, le=1.0)
    professional_placeholder_score: float = Field(ge=0.0, le=1.0)
    professional_concision_score: float = Field(ge=0.0, le=1.0)
    professional_quality_automated_score: float = Field(ge=0.0, le=1.0)
